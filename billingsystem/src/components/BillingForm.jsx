...
export default function BillingForm() {
    ...
    return (
        <div className="w-screen min-h-screen py-8 sm:px-6">
            {/* Page Title */}
            <div className="text-center px-auto mb-8">
                <h1 className="text-3xl font-bold text-gray-900 mb-10">Construction Billing</h1>
            </div>
            ...
            {showSuccessMessage && (
                <div className="fixed left-0 right-0 top-0 flex justify-center z-[9999]">
                    <div
                        className="mt-4 bg-white border border-gray-100 rounded-lg shadow-xl p-4 animate-slide-down flex items-center min-w-[300px]">
                        <svg className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor"
                             viewBox="0 0 24 24">
            ...
            <div className="max-w-7xl mx-auto flex gap-16">
                ...
                <div className="w-96">
                    <div className="bg-white rounded-lg shadow-md p-6 sticky top-8 border border-gray-100">
                        <h2 className="text-lg font-semibold text-gray-800 mb-4 border-b pb-2">Quotation
                            Details</h2>
